      ...
      <div className="col-xl-6 col-md-6 col-sm-12">
        <div className="row">
          <div className="col-xl-6 col-md-6 col-sm-12">
            <div className="row small-btn big-btn my-2 mr-1">
                <div className="col-xl-4 col-md-6 col-sm-12 d-flex align-items-center">
                    <div className="img"><img src={icon1} className="img-fluid image-color" alt=""/></div>
                </div>
                <div className="col-8">
                    <h2>700+</h2>
                    <p>Happy Clints</p>
          ...
          <div className="col-xl-6 col-md-6 col-sm-12">
            <div className="row small-btn big-btn my-2 mr-1">
                <div className="col-xl-4 col-md-6 col-sm-12 d-flex align-items-center">
                    <div className="img"><img src={icon2} className="img-fluid image-color" alt=""/></div>
          ...
          <div className="col-xl-6 col-md-6 col-sm-12">
            <div className="row small-btn big-btn my-2 mr-1">
                <div className="col-xl-4 col-md-6 col-sm-12 d-flex align-items-center">
                    <div className="img"><img src={icon3} className="img-fluid image-color" alt=""/></div>
          ...
          <div className="col-xl-6 col-md-6 col-sm-12">
            <div className="row small-btn big-btn my-2 mr-1">
                <div className="col-xl-4 col-md-6 col-sm-12 d-flex align-items-center">
                    <div className="img"><img src={icon4} className="img-fluid" alt=""/></div>
